...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["navigator-js"] = factory();
	else
		root["navigator-js"] = factory();
})(this, function() {
	...
	(function () {
	   ...
	   */
			...
			_flow.swapIn = function () {
				...
				var path, state, swapByPathList, responder, truncatedState, i;
			...
			_transition.notifyComplete = function (responder, status, behavior) {
				...
				var asynchResponders, callbackMethod;
			...
			_hidden.hasResponder = function (responder) {
				...
				var respondersByPath, existingResponders, i, j;
...
/***/ function(module, exports) {
	...
	(function () {
	  ...
	  this.navigatorjs.NavigatorEvent.TRANSITION_FINISHED = "TRANSITION_FINISHED";
	}).call(window);
		...
		(function () {
			...
			function _handleStateRequested(e, eventData) {
				var requestedState = eventData.state,
				    ...
				    recipe,
				    recipeStates,
				    recipesLength = _orderedRecipes.length,
				    j,
				    state,
				    statesLength,
				    viewInstance;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var ReactDOM = __webpack_require__(18);
		var ReactTestUtils = __webpack_require__(176);
		...
		(function () {
			...
			ViewRecipe.prototype = {
				...
				toView: function (viewClass) {
					...
					this._type = !!viewClass.prototype.setState ? 'REACT' : 'BACKBONE';
				...
				isMounted: function () {
					...
					if (this._type === 'REACT') {
						...
						// return this._viewInstance
							...
							return this.isInstantiated() && $.contains(document.documentElement, this.getViewInstance().$el);
						}
				},
